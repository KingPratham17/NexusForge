...
export default function Login({ onLogin, onSwitchToSignup }) {
  ...
  return (
    <div className="glass-panel" style={{ maxWidth: '400px', margin: '40px auto', padding: '32px' }}>
      <h2 style={{ marginBottom: '20px', textAlign: 'center' }}>Login to NexusForge</h2>
      ...
      <div style={{ textAlign: 'center' }}>
        <button onClick={onSwitchToSignup} style={{ background: 'none', border: 'none', color: '#2563eb', cursor: 'pointer', textDecoration: 'underline' }}>
